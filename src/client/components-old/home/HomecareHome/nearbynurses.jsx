        ...
        <div className="row">
          <div className="col-md-12">
              ...
              <OwlCarousel {...options}>
                <div className="nurse-profile" data-aos="fade-down">
                  ...
                  <div className="nurse-pofile-info">
                    <div className="nurse-name">
                      <h5>
                        <Link to="/doctor-profile">Elizabeth Penelope</Link>
                      </h5>
                ...
                <div className="nurse-profile" data-aos="fade-down">
                  ...
                  <div className="nurse-pofile-info">
                    <div className="nurse-name">
                      <h5>
                        <Link to="/doctor-profile">Dorothy Joanne</Link>
                      </h5>
                ...
                <div className="nurse-profile" data-aos="fade-down">
                  ...
                  <div className="nurse-pofile-info">
                    <div className="nurse-name">
                      <h5>
                        <Link to="/doctor-profile">Rachel Sophie</Link>
                      </h5>
                      <span>United States</span>
                    </div>
                    <div className="nurse-details">
                ...
                <div className="nurse-profile" data-aos="fade-down">
                  ...
                  <div className="nurse-pofile-info">
                    <div className="nurse-name">
                      <h5>
                        <Link to="/doctor-profile">Carolyn</Link>
                      </h5>
                      <span>United States</span>
                    </div>
                    <div className="nurse-details">
                ...
                <div className="nurse-profile" data-aos="fade-down">
                  ...
                  <div className="nurse-pofile-info">
                    <div className="nurse-name">
                      <h5>
                        <Link to="/doctor-profile">Jasmine Madeleine</Link>
                      </h5>
                      <span>United States</span>
                    </div>
                    <div className="nurse-details">
                ...
                <div className="nurse-profile" data-aos="fade-down">
                  ...
                  <div className="nurse-pofile-info">
                    <div className="nurse-name">
                      <h5>
                        <Link to="/doctor-profile">Samantha Tracey</Link>
                      </h5>
                      <span>United Kingdom</span>
                    </div>
                    <div className="nurse-details">
            ...
            <div className="owl-nav-button">
              ...
              <Link to="/doctor-profile" className="view-all">
                View All Nurses
              </Link>
            </div>
          </div>
